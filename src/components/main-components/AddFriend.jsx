  ...
  return (
    <div className='h-full'>
        <div className='px-[30px] py-[19px] border-b border-gray-7'>
            ...
            <div className='text-secondary-gray text-sm'>You can add a friend with their Discord Name. It's cAsE sEnSitIvE!</div>
            <div style={{ border: `1px solid ${sendRequestDivBorderColor === '#f38688' ? 'red' : sendRequestDivBorderColor}` }} className='w-full bg-black flex items-center mt-4 px-3 rounded-lg'>
