...
export default function LoadingDiv({ activeDiv }) {
  ...
  return (
    <div className={activeDiv === 'loading' ? 'w-[480px] regform:px-4 h-28 bg-main-gray rounded-main active flex items-center justify-center' : 'w-[480px] h-28 rounded-main bg-main-gray flex items-center justify-center'}>
